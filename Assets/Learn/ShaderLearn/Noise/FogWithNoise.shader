// 基于深度纹理的高度雾效，根本原理是重建像素在世界空间中的坐标位置，然后根据高度获取雾效
// 在基础上又加上了噪声，让雾自由流动
Shader "ShaderLearn/FogWithNoise"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        float4x4 _FrustumCornersRay;  // 虽然没有在Properties中声明，但仍可由脚本传递给Shader。
        sampler2D _MainTex;
        ...
        fixed4 frag(v2f i):SV_Target
        {
           ...
           // 把该值减去0.5，再乘以控制噪声程度的属性_NoiseAmount，
