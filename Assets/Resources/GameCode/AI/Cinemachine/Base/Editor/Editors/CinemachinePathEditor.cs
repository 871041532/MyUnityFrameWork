...
namespace Cinemachine.Editor
{
    ...
    internal sealed class CinemachinePathEditor : BaseEditor<CinemachinePath>
    {
        ...
        void DrawTangentControl(int i)
        {
            ...
            Handles.SphereHandleCap(0, hPos, rotation, size, UnityEngine.EventType.Repaint);
        ...
        void DrawPositionControl(int i)
        {
            ...
            Handles.SphereHandleCap(0, wp.position, rotation, size, UnityEngine.EventType.Repaint);
