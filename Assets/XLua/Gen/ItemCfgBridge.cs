...
{
    public class ItemCfgBridge : LuaBase, ItemCfg
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new ItemCfgBridge(reference, luaenv);
		}
		
		public ItemCfgBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
